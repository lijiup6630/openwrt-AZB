...
/* 802.11AX HE OPERATION PARAMS field offsets */
#define HE_OPER_6GHZ_INFO_CHANNEL_OFFSET	0
#define HE_OPER_6GHZ_INFO_CONTROL_OFFSET	1
#define HE_OPER_6GHZ_INFO_SEG0_OFFSET		2
#define HE_OPER_6GHZ_INFO_SEG1_OFFSET		3
...
int get_num_width(int vht_width, int secondary, bool op_class_6g);
...
void hostapd_set_conf_from_freq_params(struct hostapd_iface *iface, const struct hostapd_freq_params *freq_params);
