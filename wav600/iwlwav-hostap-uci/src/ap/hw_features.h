...
static inline int hostapd_acs_completed(struct hostapd_iface *iface, int err, int set_channel)
{
	return -1;
}

static inline int hostapd_select_hw_mode(struct hostapd_iface *iface, int check_chans)
{
	return -100;
}
