...
#define WLAN_EID_EXT_HE_6GHZ_BAND_CAPABILITIES 59
...
#define WLAN_EXT_CAPAB_EXT_CSA_MASK				BIT(2)
...
struct ieee80211_he_capabilities {
	 ...
	 * PPE thresholds size can be a max of 25 octets : 7 bits HDR + (8 NSS * 4 RU * 6 bits) = 199 bits => 25 octets*/
	u8 optional[37];
} STRUCT_PACKED;
...
struct ieee80211_he_operation {
	...
	u8 he_6gh_operation_information[5];
} STRUCT_PACKED;
...
#define HE_PPE_THRES_MAX_LEN 25
#define HE_PPE_THRES_INDEX 12
#define MIN_HE_MCS_NSS_LEN 4
#define MAX_HE_MCS_LEN 12
#define SIZE_HE_MCS_MAP_160_MHZ 4
#define SIZE_HE_MCS_MAP_80_80_MHZ 4

/* IEEE 802.11AX DRAFT VER 4.0 */
/* HE PHY Capabilities Information field defines */
/* B0 - Reserved */
#define HE_PHYCAP_CAP0_IDX 0
#define HE_PHY_CAP0_CHANNEL_WIDTH_SET ((u8) (BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7)))
...
#define HE_OPERATION_CAP0_TXOP_DUR_RTS_TH ((u8) (BIT(4) | BIT(5) | BIT(6) | BIT(7)))

#define HE_OPERATION_CAP1_IDX	1
#define HE_OPERATION_CAP1_TXOP_DUR_RTS_TH ((u8) (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5)))
...
#define HE_OPERATION_BSS_COLOR_2_4GHZ             0x4  /* Default BSS color value for 2.4GHz band */
#define HE_OPERATION_BSS_COLOR_5GHZ               0x5  /* Default BSS color value for 5GHz band */
/* HE BSS Color Information field defines */
#define HE_OPERATION_CAP3_IDX 3
#define HE_OPERATION_BSS_COLOR ((u8) (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5)))
...
/* HE 6GHz Band capabilities element info */
/* 80211ax. D4.3 9.4.2.256 */
#define HE_6G_BAND_CAPB_MINIMUM_MPDU_SPACING ((u16) BIT(0) | BIT(1) | BIT(2))
#define HE_6G_BAND_CAPAB_MAX_AMPDU_LENGTH_EXPONENT ((u16) BIT(3) | BIT(4) | BIT(5))
#define HE_6G_BAND_CAPAB_MAX_MPDU_LENGTH_MASK ((u16) BIT(6) | BIT(7) | BIT(8))
...
/* B36..B39 - Reserved */
#define HT_INFO_HT_PARAM_TX_MCS_SET_DEFINED 0x01
...
#define MULTI_AP_SUB_ELEM_DEF_VLAN 0x08
#define MULTI_AP_PROFILE2_DISALLOWED BIT(2)
#define MULTI_AP_PROFILE1_DISALLOWED BIT(3)
...
#define MULTI_AP_PROFILE_SUBELEMENT_ID	0x07
#define MULTI_AP_PROFILE_SUBELEMENT_LEN	0x01
#define MULTI_AP_PROFILE1		0x01
#define MULTI_AP_PROFILE2		0x02

#define MULTI_AP_8021Q_SUBELEMENT_ID	0x08
#define MULTI_AP_8021Q_SUBELEMENT_LEN	0x02
...
#define FRAME_20TU_PROBE_RESPONSE_ENABLE 1
#define FILS_DISCOVERY_ENABLE 2
#define DISABLE_UNSOLICITED_FRAME_SUPPORT 0
#define MIN_UNSOLICITED_FRAME_DURATION 0
#define MAX_UNSOLICITED_FRAME_DURATION 20
...
struct he_override_hw_capab {
	...
	int  he_mac_ul_2x996tone_ru_support;
	...
	int  he_phy_stbc_tx_greater_than_80mhz;
	...
	int  he_phy_dcm_max_bw;
	int  he_phy_er_su_ppdu_4x_ltf_8us_gi;
	...
	int  he_phy_longer_than_16_he_sigb_ofdm_sym_support;
	int  he_phy_rx_1024_qam_lt_242_tone_ru_support;
	int  he_phy_rx_full_bw_su_using_mu_non_comp_sigb;
	int  he_phy_rx_full_bw_su_using_mu_comp_sigb;
				   ...
				   struct he_override_hw_capab *cap_idx)
{
	if (os_strcmp(buf, "he_phy_preamble_puncturing_rx") == 0) {
		...
		he_phy_capab_info[HE_PHYCAP_CAP8_IDX] |= ltq_set_he_cap(atoi(pos),
			...
			struct he_override_hw_capab *cap_idx)
{
	...
	if (cap_idx->he_phy_dcm_max_bw)
		ltq_clr_set_he_cap(&debug_he_phy[HE_PHYCAP_CAP8_IDX],
