...
#define LAST_6G_CENTRE_FREQ_BW20_IN_MHZ		7115
...
struct oper_class_map {
	...
	u8 max_chan;
	u8 inc;
	enum { BW20, BW40PLUS, BW40MINUS, BW40, BW80, BW2160, BW160, BW80P80, BW4320,
	       BW6480, BW8640} bw;
...
void ch_width_and_ch_num_to_seg_idx(int chan_width, u8 channel_num, u8* seg0, u8* seg1);
