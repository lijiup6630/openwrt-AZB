...
#define INVALID_CIPHER_SUITE_6G (WPA_CIPHER_NONE | \
				WPA_CIPHER_WEP40 | \
				WPA_CIPHER_WEP104 | \
				WPA_CIPHER_TKIP)
...
#define EXT_CAP_MAX_NUM_MSDU_IN_AMSDU_DEFAULT	EXT_CAP_MAX_NUM_MSDU_IN_AMSDU_MIN
...
#define CHWIDTH_160 160
#define CHWIDTH_40 40
#define CHWIDTH_80 80
