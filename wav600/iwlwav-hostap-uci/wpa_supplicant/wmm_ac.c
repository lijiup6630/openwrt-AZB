...
#undef PARAM_IN_RANGE
	...
	/* This check eliminates KW issue SV.TAINTED.CALL.INDEX_ACCESS */
	if (params->user_priority < 0 || params->user_priority > WMM_AC_MAX_USER_PRIORITY)
		return 0;
