...
const struct nla_policy nl80211_policy[NUM_NL80211_ATTR] = {
	...
	[NL80211_ATTR_HE_OPERATION] = { .type = NLA_BINARY,
					.len = NL80211_HE_OPERATION_LEN },
			 ...
			 const struct ieee80211_sband_iftype_data *iftdata)
{
	...
	const struct ieee80211_he_6ghz_capa *he_6ghz_capa = &iftdata->he_6ghz_capa;
	...
	if (he_cap->has_he) {
		if (nla_put(msg, NL80211_BAND_IFTYPE_ATTR_HE_CAP_MAC,
		    ...
		    nla_put(msg,NL80211_BAND_IFTYPE_ATTR_HE_6GHZ_CAPA,
			    sizeof(he_6ghz_capa->capa), &he_6ghz_capa->capa))
			return -ENOBUFS;
				      ...
				      struct ieee80211_supported_band *sband)
{
	...
	if (sband->ht_cap.ht_supported &&
	    (nla_put(msg, NL80211_BAND_ATTR_HT_MCS_SET,
	     ...
	     nla_put_u32(msg, NL80211_BAND_ATTR_HT_TX_BF_CAPA,
			 sband->ht_cap.tx_BF_cap_info)))
		return -ENOBUFS;
			       ...
			       struct station_parameters *params)
{
	...
	if (nla_parse_nested_deprecated(flags, NL80211_STA_FLAG_MAX, nla,
				    ...
				    struct station_parameters *params)
{
	...
	if (info->attrs[NL80211_ATTR_HE_OPERATION]) {
		params->he_oper_iwlwav =
			nla_data(info->attrs[NL80211_ATTR_HE_OPERATION]);
	}
...
do {									\
	...
	if (!info->attrs[NL80211_ATTR_MESH_CONFIG])
		return -EINVAL;
	if (nla_parse_nested_deprecated(tb, NL80211_MESHCONF_ATTR_MAX,
...
#if 0 // enli enli LINUX_VERSION_IS_GEQ(5,3,0)
