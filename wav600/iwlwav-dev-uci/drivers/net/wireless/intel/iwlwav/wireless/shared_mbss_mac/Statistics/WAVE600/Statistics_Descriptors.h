...
#define MAX_NUM_OF_SP_BAND_0_A0 			(32) // number of SPs in Band_0 for D2 only - beware - also defined in twtManager.h
#define MAX_NUM_OF_SP_BAND_1_A0				(32) // number of SPs in Band_1 for D2 only - beware - also defined in twtManager.h
...
#error "Driver and FW byte counte usage is not match for wave600"
#endif //WORKAROUND_FOR_HW_BUG_IN_OTFA_BYTE_COUNTER_CALCULATION

#else
#define HOST_INTERFACE_BYTE_COUNTER_RESET_VALUE_WAVE600		(0x1)
#endif
...
#else
	UplinkBsrcPerTidCnt_t_wave600 BsrcPerTidCnt[HW_NUM_OF_STATIONS];
#endif
#ifdef CPU_ARC
} UplinkBsrcTidCnt_t;
#else
} UplinkBsrcTidCnt_t_wave600;
#endif
...
#else
	ul_mu_stats_t_wave600 uplinkMuStats[HW_NUM_OF_STATIONS];
	dl_mu_stats_t_wave600 downlinkMuStats[HW_NUM_OF_STATIONS];
#endif
#ifdef CPU_ARC
} PlanManagerStatistics_t;
#else
} PlanManagerStatistics_t_wave600;
#endif
...
#else
} twt_individual_params_t_wave600;
#endif
...
#else
} twt_broadcast_params_t_wave600;
#endif
...
#else
	twt_operation_t_wave600 operation;
	union 
	{
		twt_individual_params_t_wave600 individual;
		twt_broadcast_params_t_wave600 broadcast;
	} params;
#endif
#ifdef CPU_ARC
} twt_agreement_t;
#else
} twt_agreement_t_wave600;
#endif
...
#else
	twt_agreement_t_wave600 twtIndividualAgreement[TWT_MAX_INDIVIDUAL_AGREEMENTS_ALLOWED_PER_STA];
#endif
#ifdef CPU_ARC
} twt_params_t;
#else
} twt_params_t_wave600;
#endif
...
#else
	uint32 numOfStaInSp[MAX_NUM_OF_SP_BAND_0_A0 + MAX_NUM_OF_SP_BAND_1_A0];
	twt_params_t_wave600 twtStaParams[HW_NUM_OF_STATIONS];
#endif
#ifdef CPU_ARC
} TwtStatistics_t;
#else
...
typedef struct _StatisticsDb_t_wave600
{
	...
	UplinkBsrcTidCnt_t_wave600							uplinkBsrcTidCnt;
	...
	PlanManagerStatistics_t_wave600						planManagerStats;
	AlphaFilterStatistics_t_wave600						alphaFilterStats;	
