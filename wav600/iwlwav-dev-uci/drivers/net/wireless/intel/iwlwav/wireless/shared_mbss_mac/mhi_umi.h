...
#define ALL_SID_MAX             MAX(GEN6_ALL_STA_SID, GEN7_ALL_STA_SID)
...
#define UM_MAN_SET_EXCESSIVE_RETRIES_LIMIT_REQ	UMI_MSG_MAN_REQ(UMI_MAN_SET_EXCESSIVE_RETRIES_LIMIT) // 0x0487
#define MC_MAN_SET_EXCESSIVE_RETRIES_LIMIT_CFM	UMI_MSG_MAN_CFM(UMI_MAN_SET_EXCESSIVE_RETRIES_LIMIT) // 0x1487

#define UM_MAN_SET_AP_MGMT_FRAME_POWER_CONTROL_REQ    UMI_MSG_MAN_REQ(UMI_MAN_SET_AP_MGMT_FRAME_POWER_CONTROL) // 0x0488
#define MC_MAN_SET_AP_MGMT_FRAME_POWER_CONTROL_CFM    UMI_MSG_MAN_CFM(UMI_MAN_SET_AP_MGMT_FRAME_POWER_CONTROL) // 0x1488

#define UM_MAN_SET_CSI_ENABLE_REQ    		UMI_MSG_MAN_REQ(UMI_MAN_SET_CSI_ENABLE)		// 0x0489
#define MC_MAN_SET_CSI_ENABLE_CFM    		UMI_MSG_MAN_CFM(UMI_MAN_SET_CSI_ENABLE) 	// 0x1489

#define UM_MAN_CSI_SEND_MACNDP_REQ    		UMI_MSG_MAN_REQ(UMI_MAN_CSI_SEND_MACNDP) 	// 0x0490
#define MC_MAN_CSI_SEND_MACNDP_CFM    		UMI_MSG_MAN_CFM(UMI_MAN_CSI_SEND_MACNDP) 	// 0x1490

#define UM_MAN_CSI_AUTO_RATE_REQ    		UMI_MSG_MAN_REQ(UMI_MAN_CSI_AUTO_RATE) 		// 0x0491
#define MC_MAN_CSI_AUTO_RATE_CFM    		UMI_MSG_MAN_CFM(UMI_MAN_CSI_AUTO_RATE) 		// 0x1491

#define UM_MAN_REPEATER_TO_3ADDRESS_GW_REQ		UMI_MSG_MAN_REQ(UMI_MAN_REPEATER_TO_3ADDRESS_GW) // 0x0492
#define MC_MAN_REPEATER_TO_3ADDRESS_GW_CFM		UMI_MSG_MAN_CFM(UMI_MAN_REPEATER_TO_3ADDRESS_GW) // 0x1492
