...
#else
} MuOfdmaCountersStatsPerSta_t_wave700;
#endif
...
#else
	MuRuStatistics_t_wave700 muRu[WAVE600_NUM_OF_RU_SIZES];
} SuMuStaStatistics_t_wave700;
#endif
...
#else
	SuMuStaStatistics_t_wave700 suMuStations[HW_NUM_OF_STATIONS];
} MuOfdmaSuMuStats_t_wave700;
#endif
...
#else
} MuOfdmaGroupsCounters_t_wave700;
#endif
...
#else
	MuOfdmaCountersStatsPerSta_t_wave700 staCounts[HW_NUM_OF_STATIONS];
	MuOfdmaSuMuStats_t_wave700 suMuCounts;
	MuOfdmaGroupsCounters_t_wave700 groupCounts;
} LinkAdaptationMuOfdmaStatistics_t_wave700;
#endif
...
typedef struct 
{
	...
	//uint32	dynamicBW320MHz[GEN6_NUM_OF_BANDS];
#ifdef CPU_ARC
...
typedef struct _StatisticsDb_t_wave700
{
	...
	LinkAdaptationMuOfdmaStatistics_t_wave700			linkAdaptationMuOfdmaStats;
