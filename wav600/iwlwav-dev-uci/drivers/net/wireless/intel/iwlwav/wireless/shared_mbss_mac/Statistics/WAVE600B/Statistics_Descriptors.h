...
#else
} MuOfdmaCountersStatsPerSta_t_wave600b;
#endif
...
#else
	MuRuStatistics_t_wave600b muRu[WAVE600_NUM_OF_RU_SIZES];
} SuMuStaStatistics_t_wave600b;
#endif
...
#else
	SuMuStaStatistics_t_wave600b suMuStations[HW_NUM_OF_STATIONS];
} MuOfdmaSuMuStats_t_wave600b;
#endif
...
#else
} MuOfdmaGroupsCounters_t_wave600b;
#endif
...
#else
	MuOfdmaCountersStatsPerSta_t_wave600b staCounts[HW_NUM_OF_STATIONS];
	MuOfdmaSuMuStats_t_wave600b suMuCounts;
	MuOfdmaGroupsCounters_t_wave600b groupCounts;
} LinkAdaptationMuOfdmaStatistics_t_wave600b;
#endif
...
typedef struct _StatisticsDb_t_wave600b
{
	...
	LinkAdaptationMuOfdmaStatistics_t_wave600b				linkAdaptationMuOfdmaStats;
