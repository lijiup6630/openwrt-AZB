...
#define	REG_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG                  (BA_ANALYZER_BASE_ADDRESS + 0x9C)
...
#define	REG_BA_ANALYZER_FIFO_STATUS                                (BA_ANALYZER_BASE_ADDRESS + 0xA8)
#define	REG_BA_ANALYZER_FSM_STATUS0                                (BA_ANALYZER_BASE_ADDRESS + 0xAC)
#define	REG_BA_ANALYZER_FSM_STATUS1                                (BA_ANALYZER_BASE_ADDRESS + 0xB0)
#define	REG_BA_ANALYZER_LOGGER_FILTER0                             (BA_ANALYZER_BASE_ADDRESS + 0xB4)
#define	REG_BA_ANALYZER_LOGGER_FILTER1                             (BA_ANALYZER_BASE_ADDRESS + 0xB8)
...
typedef union
{
	...
	struct
	{
		...
		uint32 srDropUserRtAdaptWhileFullInt : 1; //Rate adaptive user report dropped because FIFO was full., reset value: 0x0, access type: RO
		uint32 reserved0 : 24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 crDropUserRtAdaptWhileFullIntEn : 1; //enable drop_user_rt_adapt_while_full_int., reset value: 0x1, access type: RW
		uint32 reserved0 : 24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 crClrDropTxStWhileFullInt : 1; //Clear drop_tx_st_while_full_int., reset value: 0x0, access type: WO
		uint32 crClrDropCommonRtAdaptWhileFullInt : 1; //Clear drop_common_rt_adapt_while_full_int., reset value: 0x0, access type: WO
		uint32 crClrDropUserRtAdaptWhileFullInt : 1; //Clear drop_user_rt_adapt_while_full_int., reset value: 0x0, access type: WO
		uint32 reserved0 : 24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 crBaAnalyzerCountersEn : 25; //ba_analyzer_counters_en, reset value: 0x0, access type: RW
		uint32 reserved0 : 7;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 crStsReportFifoRdEntriesNum : 9; //Tx status report FIFO number of entries to decrement., reset value: 0x0, access type: RW
		uint32 reserved0 : 23;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 crRaCommonReportFifoRdEntriesNum : 9; //Rate adaptive common report FIFO number of entries to decrement., reset value: 0x0, access type: RW
		uint32 reserved0 : 23;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 crRaUserReportFifoClearFullDropCtrStrb : 1; //Clear Rate adaptive user report FIFO full drop counter. , By writing '1'., reset value: 0x0, access type: WO
...
typedef union
{
	...
	struct
	{
		uint32 crRaUserReportFifoRdEntriesNum : 9; //Rate adaptive user report FIFO number of entries to decrement., reset value: 0x0, access type: RW
		uint32 reserved0 : 23;
	} bitFields;
...
/*REG_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG 0x9C */
typedef union
{
	uint32 val;
	struct
	{
		...
		uint32 reserved1 : 1;
		uint32 srRaUserReportFifoFullDropCtr : 9; //Rate adaptive user report setting FIFO full drop counter, reset value: 0x0, access type: RO
		uint32 reserved2 : 3;
	} bitFields;
} RegBaAnalyzerRaUserReportFifoDebug_u;
...
/*REG_BA_ANALYZER_FIFO_STATUS 0xA8 */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_FSM_STATUS0 0xAC */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_FSM_STATUS1 0xB0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_LOGGER_FILTER0 0xB4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_LOGGER_FILTER1 0xB8 */
typedef union
{
	uint32 val;
	struct
