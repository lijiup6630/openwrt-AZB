...
Generated at:       2021-12-15 09:11:19
Purpose:
...
#define	REG_B0_MAC_TX_HC_WAPI_CONTROL                      (B0_MAC_TX_HC_BASE_ADDRESS + 0x48)
...
/*REG_B0_MAC_TX_HC_WAPI_CONTROL 0x48 */
typedef union
{
	uint32 val;
	struct
