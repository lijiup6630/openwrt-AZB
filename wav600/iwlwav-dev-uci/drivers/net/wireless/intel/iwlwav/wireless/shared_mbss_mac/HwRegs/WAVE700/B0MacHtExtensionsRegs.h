...
#define	REG_B0_MAC_HT_EXTENSIONS_STD_CONTENTION_EVENTS            (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0x90)
#define	REG_B0_MAC_HT_EXTENSIONS_EVENT_CONTROL                    (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0x94)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON         (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA0)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN           (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA4)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON2        (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA8)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_MPA_ARB          (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xAC)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN2          (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xB0)
#define	REG_B0_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPO                 (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC0)
#define	REG_B0_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPI                 (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC4)
#define	REG_B0_MAC_HT_EXTENSIONS_PHY_MAC_IF_TEST_BUS_STOP         (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC8)
#define	REG_B0_MAC_HT_EXTENSIONS_VAP_MODE_BITMAP                  (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF0)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON3        (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF4)
#define	REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN3          (B0_MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF8)
/*---------------------------------------------------------------------------------
...
/*REG_B0_MAC_HT_EXTENSIONS_STD_CONTENTION_EVENTS 0x90 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_EVENT_CONTROL 0x94 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON 0xA0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN 0xA4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON2 0xA8 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_MPA_ARB 0xAC */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN2 0xB0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPO 0xC0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPI 0xC4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_PHY_MAC_IF_TEST_BUS_STOP 0xC8 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_VAP_MODE_BITMAP 0xF0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON3 0xF4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN3 0xF8 */
typedef union
{
	uint32 val;
	struct
