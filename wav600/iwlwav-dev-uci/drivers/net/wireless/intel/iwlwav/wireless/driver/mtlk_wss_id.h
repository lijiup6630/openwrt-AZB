...
#endif
  MTLK_WWSS_WLAN_STAT_ID_PD_BROADCAST_PACKETS_SENT,
  MTLK_WWSS_WLAN_STAT_ID_PD_BROADCAST_BYTES_SENT_64,
  MTLK_WWSS_WLAN_STAT_ID_PD_UNICAST_PACKETS_SENT,
  MTLK_WWSS_WLAN_STAT_ID_PD_UNICAST_BYTES_SENT_64,
  MTLK_WWSS_WLAN_STAT_ID_PD_MULTICAST_PACKETS_SENT,
  MTLK_WWSS_WLAN_STAT_ID_PD_MULTICAST_BYTES_SENT_64,
...
#define MTLK_WWSS_WLAN_STAT_ID_PD_BROADCAST_PACKETS_SENT_ALLOWED                    MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
#define MTLK_WWSS_WLAN_STAT_ID_PD_BROADCAST_BYTES_SENT_64_ALLOWED                   MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
#define MTLK_WWSS_WLAN_STAT_ID_PD_UNICAST_PACKETS_SENT_ALLOWED                      MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
#define MTLK_WWSS_WLAN_STAT_ID_PD_UNICAST_BYTES_SENT_64_ALLOWED                     MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
#define MTLK_WWSS_WLAN_STAT_ID_PD_MULTICAST_PACKETS_SENT_ALLOWED                    MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
#define MTLK_WWSS_WLAN_STAT_ID_PD_MULTICAST_BYTES_SENT_64_ALLOWED                   MTLK_WWSS_WLAN_STAT_GROUP_ALLWAYS_ALLOWED
