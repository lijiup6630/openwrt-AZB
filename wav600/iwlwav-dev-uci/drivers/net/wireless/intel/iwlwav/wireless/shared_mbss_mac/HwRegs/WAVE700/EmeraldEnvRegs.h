...
Generated at:       2021-12-15 09:12:38
Purpose:
...
#define	REG_EMERALD_ENV_HOST_IF_NOCS_TIMEOUT_EN          (EMERALD_ENV_BASE_ADDRESS + 0x2A4)
#define	REG_EMERALD_ENV_CPU_NOC_TIMEOUT_EN               (EMERALD_ENV_BASE_ADDRESS + 0x2A8)
...
/*REG_EMERALD_ENV_HOST_IF_NOCS_TIMEOUT_EN 0x2A4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hostIfNocsTimeoutEn : 1; //no description, reset value: 0x0, access type: RW
		uint32 reserved0 : 31;
	} bitFields;
} RegEmeraldEnvHostIfNocsTimeoutEn_u;

/*REG_EMERALD_ENV_CPU_NOC_TIMEOUT_EN 0x2A8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 cpuNocTimeoutEn : 1; //no description, reset value: 0x1, access type: RW
		uint32 reserved0 : 31;
	} bitFields;
} RegEmeraldEnvCpuNocTimeoutEn_u;
