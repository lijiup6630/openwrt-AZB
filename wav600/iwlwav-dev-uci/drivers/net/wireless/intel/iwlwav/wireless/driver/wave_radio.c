  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_host_if_qos, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*peer_host_if_qos));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_host_if_qos),
      peer_host_if_qos);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_host_if, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_host_if),
      peer_host_if);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_rx_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*peer_rx_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_rx_stats),
      peer_rx_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_ul_bsrc_tid, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*peer_ul_bsrc_tid));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_ul_bsrc_tid),
      peer_ul_bsrc_tid);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_baa_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*peer_baa_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_baa_stats),
      peer_baa_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(link_adaption_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*link_adaption_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*link_adaption_stats),
      link_adaption_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(plan_manager_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*plan_manager_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*plan_manager_stats),
      plan_manager_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(twt_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*twt_stats),
      twt_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(per_client_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*per_client_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*per_client_stats),
      per_client_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(phy_rx_status, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*phy_rx_status));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*phy_rx_status),
      phy_rx_status);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(peer_info, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*peer_info),
      peer_info);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(wlan_host_if_qos, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, wlan_host_if_qos);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(wlan_host_if, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, wlan_host_if);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(wlan_rx_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, wlan_rx_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(wlan_baa_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, wlan_baa_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(radio_rx_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, radio_rx_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(radio_baa_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, radio_baa_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(ts_init_tid_gl, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, ts_init_tid_gl);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(ts_init_sta_gl, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, ts_init_sta_gl);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(ts_rcpt_tid_gl, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, ts_rcpt_tid_gl);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(ts_rcpt_sta_gl, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, ts_rcpt_sta_gl);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(link_adapt_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, link_adapt_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(mc_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, mc_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(trman_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, trman_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(grman_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, grman_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(gen_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, gen_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(channel_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, channel_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(phy_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, phy_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(dy_bw_stats, stats_size)
    ...
    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, stats_size, dy_bw_stats);
  ...
  int data_len)
{
  ...
  MTLK_CLPB_TRY(link_mu_stats, stats_size)
    rsp_nbuf = wv_cfg80211_vendor_cmd_alloc_reply_skb(wiphy,
      sizeof(*link_mu_stats));
    if (!rsp_nbuf) {
      MTLK_CLPB_EXIT(MTLK_ERR_NO_MEM);
    }

    nla_put(rsp_nbuf, NL80211_ATTR_VENDOR_DATA, sizeof(*link_mu_stats),
      link_mu_stats);
