...
typedef enum
{
  ...
  WAVE_CORE_REQ_GET_LAMUOFDMA_STATS,             /*!< Get Link Adapt Mu_OFDMA Stats */
  ...
  WAVE_CORE_SEND_CSI_STATS_EVENT,                /*!< Send CSI Stats event to user space */
...
typedef struct _wave_vap_su_mu_ru_stats_t {
  uint64 vap_success_su_ampdus;
  uint64 vap_failed_su_ampdus;
  uint64 vap_success_ru_ampdus[NUM_OF_RU_SIZES];
  uint64 vap_failed_ru_ampdus[NUM_OF_RU_SIZES];
} wave_vap_su_mu_ru_stats_t;
