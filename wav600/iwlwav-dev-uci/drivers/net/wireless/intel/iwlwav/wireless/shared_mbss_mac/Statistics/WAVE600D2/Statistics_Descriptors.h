...
#ifdef CPU_ARC
} MuOfdmaCountersStatsPerSta_t;
#else
} MuOfdmaCountersStatsPerSta_t_wave600d2;
#endif

typedef struct
{
	uint32 successRuAmpdus;
	uint32 failedRuAmpdus;
#ifdef CPU_ARC
} MuRuStatistics_t;
#else
} MuRuStatistics_t_wave600d2;
#endif

typedef struct
{
	uint32 successSuAmpdus;
	uint32 failedSuAmpdus;
#ifdef CPU_ARC
	MuRuStatistics_t muRu[WAVE600_NUM_OF_RU_SIZES];
} SuMuStaStatistics_t;
#else
	MuRuStatistics_t_wave600d2 muRu[WAVE600_NUM_OF_RU_SIZES];
} SuMuStaStatistics_t_wave600d2;
#endif

typedef struct
{
#ifdef CPU_ARC
	SuMuStaStatistics_t suMuStations[HW_NUM_OF_STATIONS];
} MuOfdmaSuMuStats_t;
#else
	SuMuStaStatistics_t_wave600d2 suMuStations[HW_NUM_OF_STATIONS];
} MuOfdmaSuMuStats_t_wave600d2;
#endif

typedef struct
{
	uint32 dlGroupCreatedCounter;
	uint32 dlGroupRemovedCounter;
	uint32 ulGroupCreatedCounter;
	uint32 ulGroupRemovedCounter;
#ifdef CPU_ARC
} MuOfdmaGroupsCounters_t;
#else
} MuOfdmaGroupsCounters_t_wave600d2;
#endif

typedef struct
{
#ifdef CPU_ARC
	MuOfdmaCountersStatsPerSta_t staCounts[HW_NUM_OF_STATIONS];
	MuOfdmaSuMuStats_t suMuCounts;
	MuOfdmaGroupsCounters_t groupCounts;
} LinkAdaptationMuOfdmaStatistics_t;
#else
	MuOfdmaCountersStatsPerSta_t_wave600d2 staCounts[HW_NUM_OF_STATIONS];
	MuOfdmaSuMuStats_t_wave600d2 suMuCounts;
	MuOfdmaGroupsCounters_t_wave600d2 groupCounts;
} LinkAdaptationMuOfdmaStatistics_t_wave600d2;
#endif
...
#else
} LinkAdaptationMuStatistics_t_wave600d2;
#endif
...
typedef struct _StatisticsDb_t
{
    ...
    LinkAdaptationMuOfdmaStatistics_t						linkAdaptationMuOfdmaStats;
...
typedef struct _StatisticsDb_t_wave600d2
{
	...
	LinkAdaptationMuStatistics_t_wave600d2					linkAdaptationMuStats;
	...
	LinkAdaptationMuOfdmaStatistics_t_wave600d2				linkAdaptationMuOfdmaStats;
