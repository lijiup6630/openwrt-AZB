...
mtlk_error_t __MTLK_IFUNC wave_core_get_link_adapt_muofdma_statistics(mtlk_handle_t hcore, const void *data, uint32 data_size);
...
mtlk_error_t __MTLK_IFUNC wave_core_send_csi_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
