...
/**
 * struct ieee80211_sta_he_oper - STA's HE operation support
 *
 * This structure describes most essential 802.11ax control
 * information of HE STAs in an HE BSS.
 *
 * @he_oper_info_set: True if HE operation info is valid.
 * @he_oper_params: HE Operation Parameters[3] and BSS Color Information[1].
 * @he_mcs_nss_set: The basic HE NSS and MCS set.
 * @vht_oper_info: The VHT operation information.
 * @co_hosted_bss: The MAX Co-Hosted BSSID indicator.
 * @oper_6GHZ_info: The 6 GHZ Operation information.
 */
struct ieee80211_sta_he_oper {
	bool he_oper_info_set;
	u8 he_oper_params[4];
	u8 he_mcs_nss_set[2];
	u8 vht_oper_info[3];
	u8 co_hosted_bss;
