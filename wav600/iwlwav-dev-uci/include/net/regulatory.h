 ...
 * @REGULATORY_WIPHY_DISABLE_INTERSECTION: used to don't do intersection of
 *	regulatory domains when last request was set from Country IE, and
 *	new request comes from User. Rather use what was set by User.
 */
