...
hostapd_prepare_device_config() {
	...
	json_get_vars country country_ie beacon_int:100 doth require_mode legacy_rates \
					...
					rssi_reject_assoc_rssi mem_only_cred
...
hostapd_set_bss_options() {
	...
	json_get_vars \
		...
		maxassoc num_vrt_backhauls max_inactivity disassoc_low_ack isolate auth_cache greylist \
		...
		start_after start_after_delay start_after_watchdog_time intra_vap_mcast enable_hairpin \
		mgmt_frame_power_control greylist_logpath greylist_file cmmac transition_disable
