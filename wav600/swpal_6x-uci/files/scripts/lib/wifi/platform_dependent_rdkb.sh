...
clean_nvram(){
        rm -f /nvram/etc/config/meta-* /nvram/etc/config/network /nvram/etc/config/prplmesh /nvram/etc/config/prplmesh_db /nvram/etc/config/wireless /nvram/etc/fw_dump* /nvram/beerocks*.conf
}
